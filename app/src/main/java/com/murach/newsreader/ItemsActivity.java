...
//        //Code from NewsReaderService that will fire broadcasts
...
//        NewsReaderService.this.sendBroadcast(intent);
    ...
    class ReadFeed extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            // set publication date for currently displayed feed
    ...
    public void updateDisplay()
    {
        ...
        /* map fields keys from "from" will be bound to views with ids declared in "to"
        i.e: map.get(from[0]) <=> findViewById(to[0])
        (findViewById(R.id.pubDateTextView).setText(map.get("date")); */
    ...
    public void onItemClick(AdapterView<?> parent, View v, 
        ...
        // pass data to activity along with this intent
